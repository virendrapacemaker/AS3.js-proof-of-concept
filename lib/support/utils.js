  ...
  beebe = {
    ...
    func: {
      ...
      takesArgs: function(func) {
        // fails on "function (){return Math.sqrt(this.x_*this.x_+this.y_*this.y_)}"
        // because it searches greedy-like to the last ")"
    ...
    magic: {
       ...
       * from parent classes, this will not see the child prototype's setX or
       * getX properties.
       *
